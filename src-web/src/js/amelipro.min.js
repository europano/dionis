...
function initAmelipro(){$('[data-toggle="popover"]').popover(),$("select").selectpicker(),$(document).height()>$(window).height()?$("#btn-retour-haut").show():$("#btn-retour-haut").hide(),$(".slider").slider(),$(".datepicker, .input-group.date, .input-daterange").attr({readonly:"readonly"}).datepicker({startDate:"26/11/2018",daysOfWeekHighlighted:[0,6],todayHighlight:!0,clearBtn:!0,language:"fr",autoclose:!0}),$(".checkbox, .radio").click(function(){$(this).find("label").removeClass("active"),$(this).find("input:checked").parent("label").addClass("active")}),$(".checkbox, .radio").each(function(){$(this).find("label").removeClass("active"),$(this).find("input:checked").parent("label").addClass("active")}),$(".btn-menu, .overlay").click(function(){$("#main-menu").hasClass("open")?$("#main-menu, .overlay").removeClass("open"):$("#main-menu, .overlay").addClass("open")}),$(document).keyup(function(a){27==a.keyCode&&$("#main-menu, .overlay").removeClass("open")}),$(".show-hide-btn").each(function(){$(".show-hide-btn").find("span").addClass($(this).attr("data-hide-icon"))}),$(".show-hide-btn").click(function(){$(this).find("span").addClass($(this).attr("data-show-icon"))}),$(".show-hide").click(function(){var a=$(this).attr("data-hide"),e=$(this).attr("data-show"),t=$(this).attr("data-reverse-show-hide");""!=a&&($(a).hide(),$(this).find(".open-close").removeClass("active")),""!=e&&($(e).removeClass("hidden"),$(e).fadeOut().fadeIn(),$(this).find(".open-close").addClass("active")),t&&($(this).attr("data-hide",e),$(this).attr("data-show",a)),$("#options-maquette li").removeClass("active"),$(this).addClass("active")}),$(".notification .badge").fadeOut().fadeIn().fadeOut().fadeIn(),$(".ajax-loader").hide(),$(".panel-heading").has("[data-toggle=collapse]").addClass("bg-gris-6"),$(".panel-heading [data-toggle=collapse]").click(function(){var a=$(this).attr("data-parent");$(a+" .panel-heading").removeClass("active"),$(this).parent(".panel-heading").addClass("active")});var a=$("header");if(!a.hasClass("header-design-system")){var e=window.innerHeight/3;$(window).scroll(function(){window.pageYOffset>e?(a.addClass("sticky-header"),$("main").css("margin-top",e+"px")):(a.removeClass("sticky-header"),$("main").css("margin-top","0px"))})}$(".textarea-compteur").on("keyup change",function(){console.log("textarea-compteur");var a=$(this).val();max=$(this).attr("data-max-compteur"),textLength=a.length,textLength<max?$($(this).attr("data-compteur")).html(textLength+"/"+max):($(this).val(a.substring(0,max)),$($(this).attr("data-compteur")).html(max+"/"+max))}),$(".auto-open-modal").modal("show");var t={url:"ressources/motifs.json",getValue:"motif",list:{match:{enabled:!0}},theme:"square"};$("#caisse").easyAutocomplete(t)}$(document).ready(function(){initAmelipro()});
$(document).ready(function(){$("a[data-toggle]").on("click",function(t){t.preventDefault();var n=$(t.currentTarget).attr("href"),a=$(t.currentTarget).attr("data-target");$(a+" button").on("click",function(t){"Oui"==$(this).text()&&(window.location.href=n)})})});
